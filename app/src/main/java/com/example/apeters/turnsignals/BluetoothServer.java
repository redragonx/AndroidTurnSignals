...
public class BluetoothServer {
    ...
    private static final String NAME_SECURE = "TurnSignalsSecure";
    private static final String NAME_INSECURE = "TurnSignals";

    // Unique UUID for this application
    private static final UUID MY_UUID_SECURE =
            UUID.fromString("b98a7502-8b5e-11e5-af63-feff819cdc9f");
